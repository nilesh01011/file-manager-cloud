      ...
      >
        ...
        >
          <div className="flex items-center justify-center w-full">
            <label className="bg-white hover:bg-gray-100 flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer">
